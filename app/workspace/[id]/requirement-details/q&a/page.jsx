        ...
        <div className='overflow-y-scroll scrollbar-hide pb-[200px] pl-2 pt-1'>
          <div className='flex flex-col w-[95%] h-fit shadow-5 rounded-[5px]'>
            ...
            <div className='py-6 px-6'>
              <h1 className="text-black font-bold rounded-t pb-1">Q&A</h1>
              <p className='text-gray-500 text-sm'>Craft responses for important questions, ensuring your AI Agent shares the most relevant info. Use Custom
                  Answers for enhanced engagement.</p>
            </div>        
                            
            <form 
              onClick={handleAddSnippet}
              className="h-auto flex justify-start pb-10 items-start text-black flex-col px-10 gap-2">
